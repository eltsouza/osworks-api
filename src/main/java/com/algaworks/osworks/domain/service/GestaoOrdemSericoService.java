...
public class GestaoOrdemSericoService {
	...
	public OrdemServico criar(OrdemServico ordemServico) {
		...
		Cliente cliente = clienteRepository.findById(ordemServico.getCliente().getId())
				.orElseThrow(() -> new NegocioException("Cliente não encontrado durante o cadastro da ordem de serviço."));
    ...
    public void finalizar(Long ordemServicoId) {
		OrdemServico ordemServico = buscarOrdemService(ordemServicoId);
	...
	private OrdemServico buscarOrdemService(Long ordemServicoId) {
